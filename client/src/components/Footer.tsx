      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-xl tracking-tight">NUTRIFORK</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-400">
                ...
                <a href="mailto:bm@nutrifork.in" className="text-sm hover:text-white transition-colors">
                  bm@nutrifork.in
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Nutrifork. All rights reserved.
          </p>
